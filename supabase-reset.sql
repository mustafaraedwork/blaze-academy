-- ===================================
-- Blaze Academy Database Reset & Setup
-- إعادة إعداد قاعدة بيانات Blaze Academy
-- ===================================
--
-- هذا السكريبت يحذف الجداول القديمة ويعيد إنشائها من الصفر
-- This script drops old tables and recreates them from scratch
--
-- ===================================
...
-- ===================================
-- حذف الجداول القديمة | Drop Old Tables
-- ===================================
...
-- ===================================
-- 5. جدول مرفقات الدروس | Lesson Attachments
-- ===================================
...
-- ===================================
-- 6. جدول تقدم المستخدم | User Progress
-- ===================================
...
-- ===================================
-- 9. جدول استخدامات الكوبونات | Coupon Usage
-- ===================================
